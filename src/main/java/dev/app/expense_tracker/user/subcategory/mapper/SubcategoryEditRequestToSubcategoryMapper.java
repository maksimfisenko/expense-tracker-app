package dev.app.expense_tracker.user.subcategory.mapper;
...
public interface SubcategoryEditRequestToSubcategoryMapper extends Mapper<Subcategory, SubcategoryEditRequest> {
}
